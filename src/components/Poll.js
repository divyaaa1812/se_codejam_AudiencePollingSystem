export default class Poll {
    ...
    renderVotes () {
        ...
        this._option1VoteElement.textContent = `${this._option1Votes} ${this._option1Votes <= 1 ? 'vote' : 'votes'}`
        this._option2VoteElement.textContent = `${this._option2Votes} ${this._option2Votes <= 1 ? 'vote' : 'votes'}`;
    }
